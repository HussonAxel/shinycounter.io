...
export default function CurrentPokemonLeft({
  ...
  return (
    <div className="rounded-b-xl md:rounded-none min-h-[35vh] md:h-[calc(100vh-68px)] bg-gradient-to-br from-gray-100 to-gray-200/80 w-full md:w-2/5 flex flex-col items-center justify-center sm:p-6 md:sticky top-0 overflow-y-auto">
      ...
      <h3 className="hidden md:inline text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold capitalize text-[#1A1A1A] mb-4 sm:mb-2 text-center leading-tight">
        {pokemonDefaultName}
      </h3>
      ...
      <div className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg flex justify-center my-4 sm:my-6 md:my-8">
        <img
          ...
          className="w-32 h-32 xs:w-28 xs:h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 lg:w-48 lg:h-48 object-contain"
        />
      </div>
